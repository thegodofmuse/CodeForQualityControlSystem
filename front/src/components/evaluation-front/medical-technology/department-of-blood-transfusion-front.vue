    ...
    <div class="right">
      <div id="tables">
        ...
        <table id="table">
          ...
          <!--            <td>专项督查项目</td>-->
          <!--            <td>-->
          <!--              <template v-if="clinicData && clinicData.specialInspectionProjectData">-->
          ...
          <!--            <td>单病种</td>-->
          <!--            <td>-->
          <!--              &lt;!&ndash;          <span v-if="clinicData && clinicData.singleDiseaseData1 && clinicData.singleDiseaseData1.length > 0 && clinicData.singleDiseaseData1[0] && clinicData.singleDiseaseData1[0].averageFillingRate">&ndash;&gt;-->
          <!--              &lt;!&ndash;            年度平均上报率{{ clinicData.singleDiseaseData1[0].averageFillingRate }}%&ndash;&gt;-->
          <!--              &lt;!&ndash;          </span>&ndash;&gt;-->
          ...
          <!--            <td>合理用药</td>-->
          <!--            <td>-->
          <!--              &lt;!&ndash;          <template v-if="clinicData && clinicData.rationalAdministrationDrugData">&ndash;&gt;-->
          <!--              &lt;!&ndash;            <div v-for="(item, index) in clinicData.rationalAdministrationDrugData" :key="index">&ndash;&gt;-->
          <!--              &lt;!&ndash;              {{ item.personResponsible}}&nbsp;{{ item.admissionOutpatientNum }}&nbsp;{{ item.qualityControlDetails}}&nbsp;{{ item.assessmentResults}}&nbsp;申诉：{{ item.appeal}}&ndash;&gt;-->
          <!--              &lt;!&ndash;            </div>&ndash;&gt;-->
          <!--              &lt;!&ndash;          </template>&ndash;&gt;-->
          <!--              &lt;!&ndash;          {{ clinicData && clinicData.rationalAdministrationDrugMessage }}&ndash;&gt;-->
          <!--              详见OA传阅药学室本月质控反馈单-->
          <!--            </td>-->
          <!--            <td></td>-->
          <!--          </tr>-->
